...
export declare class SettingsController {
    ...
    updateTenant(user: any, updateTenantDto: UpdateTenantDto): Promise<{
        id: string;
        name: string;
        slug: string;
        logo: string | null;
    ...
    getUser(user: any, userId: string): Promise<{
        id: string;
        name: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    updateUser(user: any, userId: string, updateUserDto: UpdateUserDto): Promise<{
        id: string;
        name: string;
        email: string;
        role: import(".prisma/client").$Enums.Role;
