...
exports.UpdateSaleDto = exports.CreateSaleDto = exports.SaleItemDto = void 0;
...
class SaleItemDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { productVariantId: { required: true, type: () => String }, quantity: { required: true, type: () => Number }, unitPrice: { required: true, type: () => Number }, discount: { required: false, type: () => Number }, taxRate: { required: false, type: () => Number } };
    }
}
...
], SaleItemDto.prototype, "productVariantId", void 0);
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateSaleDto.prototype, "receivableId", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Matches)(/^[0-9]{44}$/, { message: 'Chave de acesso deve ter exatamente 44 dígitos numéricos' }),
    __metadata("design:type", String)
], CreateSaleDto.prototype, "invoiceKey", void 0);
class UpdateSaleDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { status: { required: false, type: () => Object }, notes: { required: false, type: () => String }, invoiceNumber: { required: false, type: () => String }, invoiceKey: { required: false, type: () => String } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateSaleDto.prototype, "invoiceNumber", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Matches)(/^[0-9]{44}$/, { message: 'Chave de acesso deve ter exatamente 44 dígitos numéricos' }),
    __metadata("design:type", String)
], UpdateSaleDto.prototype, "invoiceKey", void 0);
