...
export declare class ReportsService {
    ...
    getSalesReport(tenantId: string, startDate: Date, endDate: Date): Promise<{
        period: {
            startDate: Date;
            endDate: Date;
        };
    ...
    getInventoryReport(tenantId: string): Promise<{
        total: number;
        lowStock: number;
        outOfStock: number;
        items: ({
    ...
    getProductPerformance(tenantId: string): Promise<{
        id: string;
        name: string;
        brand: string;
        category: import(".prisma/client").$Enums.ProductCategory;
    ...
    getCustomerAnalysis(tenantId: string): Promise<{
        id: string;
        name: string;
        email: string;
        totalPurchases: number;
    ...
    getServiceOrderStats(tenantId: string): Promise<{
        total: number;
        completed: number;
        pending: number;
        cancelled: number;
